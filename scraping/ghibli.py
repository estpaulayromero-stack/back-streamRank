"""
StreamRank — scraper_ghibli.py
Scrapea Top 50 Studio Ghibli desde TMDb API
Guarda en: json/ghibli_top50.json
"""
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key":API_KEY,"language":"es-ES","with_companies":COMPANY_ID,"sort_by":"vote_average.desc","vote_count.gte":100,"page":page}
        try:
...
def main():
    ...
    resultado = {
        ...
        "plataforma":          "NETFLIX",
        "color":               "#2db87d",
        "descripcion":         "Lo mejor de Studio Ghibli",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "ghibli_top50.json")
