...
Scrapea Top 50 DC Studios desde TMDb API
Guarda en: json/dc_studios_top50.json
"""
...
def main():
    ...
    resultado = {
        ...
        "plataforma":          "MAX",
        "color":               "#0075c4",
        "descripcion":         "Lo mejor de DC Studios",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "dc_studios_top50.json")
