"""
StreamRank — scraper_fast_furious.py
Scrapea Top 50 Fast and Furious desde TMDb API
Guarda en: json/fast_furious_top50.json
"""
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key":API_KEY,"language":"es-ES","with_companies":COMPANY_ID,"sort_by":"vote_average.desc","vote_count.gte":200,"page":page}
        try:
...
def main():
    ...
    resultado = {
        "categoria":           "fast_furious",
        "nombre":              "Fast and Furious",
        "plataforma":          "PRIME VIDEO",
        "color":               "#ff6600",
        "descripcion":         "La saga completa de Fast and Furious",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "fast_furious_top50.json")
