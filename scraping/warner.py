...
============================================================
  ...
  Scrapea Top 50 Warner Bros (películas + series) desde TMDb API
...
# Warner Bros. Pictures company_id = 174
COMPANY_ID = "174"
...
def main():
    print("Scrapeando Warner Bros (películas + series)...")
    ...
    resultado = {
        "categoria": "warner", "nombre": "Warner Bros", "plataforma": "WARNER BROS",
        "color": "#003087",
        "descripcion": f"Lo mejor de Warner Bros · {n_p} películas · {n_s} series",
