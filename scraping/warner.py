"""
StreamRank — scraper_warner.py
Scrapea Top 50 Warner Bros desde TMDb API
Guarda en: json/warner_top50.json
"""
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key":API_KEY,"language":"es-ES","with_companies":"174|79","sort_by":"vote_average.desc","vote_count.gte":500,"page":page}
        try:
