"""
StreamRank — scraper_jurassic.py
Scrapea Top 50 Jurassic Park desde TMDb API
Guarda en: json/jurassic_top50.json
"""
...
def main():
    ...
    resultado = {
        ...
        "color":               "#4caf50",
        "descripcion":         "La saga completa de Jurassic Park",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "jurassic_top50.json")
