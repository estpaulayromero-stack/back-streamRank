"""
StreamRank — scraper_harry_potter.py
Scrapea Top 50 Harry Potter desde TMDb API
Guarda en: json/harry_potter_top50.json
"""
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key":API_KEY,"language":"es-ES","with_companies":COMPANY_ID,"sort_by":"vote_average.desc","vote_count.gte":500,"page":page}
        try:
...
def main():
    ...
    resultado = {
        "categoria":           "harry_potter",
        "nombre":              "Harry Potter",
        "plataforma":          "MAX",
        "color":               "#740001",
        "descripcion":         "La saga completa de Harry Potter",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "harry_potter_top50.json")
