"""
StreamRank — scraper_dc_universe.py
Scrapea Top 50 DC Universe desde TMDb API
Guarda en: json/dc_universe_top50.json
"""
...
def main():
    ...
    resultado = {
        "categoria":           "dc_universe",
        "nombre":              "DC Universe",
        "plataforma":          "MAX",
        "color":               "#1a237e",
        "descripcion":         "Lo mejor del Universo DC",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "dc_universe_top50.json")
