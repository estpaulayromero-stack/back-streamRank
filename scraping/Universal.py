...
============================================================
  ...
  Scrapea Top 50 Universal Studios (películas + series) desde TMDb API
...
# Universal Pictures company_id = 33
COMPANY_ID = "33"
...
def main():
    print("Scrapeando Universal Studios (películas + series)...")
    ...
    resultado = {
        "categoria": "universal", "nombre": "Universal Studios", "plataforma": "UNIVERSAL",
        "color": "#333333",
        "descripcion": f"Lo mejor de Universal Studios · {n_p} películas · {n_s} series",
