"""
StreamRank — scraper_dreamworks.py
Scrapea Top 50 DreamWorks Animation desde TMDb API
Guarda en: json/dreamworks_top50.json
"""
...
def main():
    ...
    resultado = {
        "categoria":           "dreamworks",
        "nombre":              "DreamWorks Animation",
        "plataforma":          "PRIME VIDEO",
        "color":               "#e8a000",
        "descripcion":         "Lo mejor de DreamWorks Animation",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "dreamworks_top50.json")
