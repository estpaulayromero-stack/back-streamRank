"""
StreamRank — scraper_startrek.py
Scrapea Top 50 Star Trek desde TMDb API
Guarda en: json/startrek_top50.json
"""
...
# Paramount Pictures (productora de Star Trek)
COMPANY_ID   = "4"
COMPANY_NAME = "Star Trek / Paramount"

# Keyword TMDb: "star trek" = 161176
KEYWORD_ID = "161176"
...
def main():
    ...
    resultado = {
        ...
        "plataforma":          "APPLE TV",
        "color":               "#1565c0",
        "descripcion":         "La saga completa de Star Trek en cine",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "startrek_top50.json")
