...
# Amazon Prime Video watch_provider_id = 9
PROVIDER_ID = "9"
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key": API_KEY, "language": "es-ES",
                  ...
                  "sort_by": "vote_average.desc", "vote_count.gte": 400, "page": page}
        try:
...
def main():
    ...
    resultado = {
        "categoria": "amazon", "nombre": "Amazon Prime", "plataforma": "PRIME VIDEO",
        "color": "#00a8e1",
