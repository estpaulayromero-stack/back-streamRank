"""
StreamRank — scraper_jamesbond.py
Scrapea Top 50 James Bond desde TMDb API
Guarda en: json/jamesbond_top50.json
"""
...
# EON Productions (productora oficial de James Bond)
COMPANY_ID   = "7576"
COMPANY_NAME = "James Bond / EON Productions"

# IDs TMDb de todas las películas oficiales de James Bond
BOND_IDS = [
    646, 657, 660, 661, 662, 663, 664, 665, 667, 668,
    669, 670, 671, 672, 673, 674, 675, 676, 677, 678,
    679, 680, 681, 682, 683, 684, 36669, 264644, 58595,
    37799, 57158, 206647, 269149, 370172
]

def get_trailer(mid):
    try:
        for lang in ["es-ES", "en-US"]:
            r = requests.get(f"{BASE_URL}/movie/{mid}/videos",
...
def fetch_peliculas():
    peliculas = []
    # Busca por keyword "james bond" (keyword id 9715 en TMDb)
    for page in range(1, 4):
        params = {
            "api_key": API_KEY,
            "language": "es-ES",
            "with_keywords": "9715",          # keyword: james bond
...
def main():
    ...
    resultado = {
        "categoria":           "jamesbond",
        "nombre":              "James Bond 007",
        "plataforma":          "APPLE TV",
        "color":               "#a0a0a0",
        "descripcion":         "La saga completa del agente 007",
        "fecha_actualizacion": datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
        "total":               len(top),
        "peliculas":           top
    }
    path = os.path.join(JSON_DIR, "jamesbond_top50.json")
