...
============================================================
  ...
  Scrapea Top 50 Star Wars (películas + series) desde TMDb API
...
# keyword "star wars" = 11451  |  Lucasfilm company_id = 1
KEYWORD_ID  = "11451"
COMPANY_ID  = "1"
...
def fetch_series():
    ...
    for page in range(1, 4):
        params = {"api_key": API_KEY, "language": "es-ES",
                  "with_keywords": KEYWORD_ID,
                  "sort_by": "vote_average.desc", "vote_count.gte": 50, "page": page}
        try:
...
def normalizar_pelicula(p):
    ...
    return {
        ...
        "genero": GENEROS.get(gids[0], "Ciencia Ficción") if gids else "Ciencia Ficción",
...
def main():
    print("Scrapeando Star Wars (películas + series)...")
    ...
    resultado = {
        "categoria": "starwars", "nombre": "Star Wars", "plataforma": "STAR WARS",
        "color": "#ffe81f",
        "descripcion": f"La galaxia muy, muy lejana · {n_p} películas · {n_s} series",
