...
============================================================
  ...
  Scrapea Top 50 Disney+ (películas + series) desde TMDb API
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key": API_KEY, "language": "es-ES",
                  "with_watch_providers": PROVIDER_ID, "watch_region": "US",
...
def normalizar_pelicula(p):
    ...
    return {
        ...
        "genero": GENEROS.get(gids[0], "Aventura") if gids else "Aventura",
...
def main():
    print("Scrapeando Disney+ (películas + series)...")
    ...
    resultado = {
        "categoria": "disney", "nombre": "Disney+", "plataforma": "DISNEY+",
        "color": "#113ccf",
        "descripcion": f"Lo mejor de Disney+ · {n_p} películas · {n_s} series",
