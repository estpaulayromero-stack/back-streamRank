"""
StreamRank — scraper_disney.py
Scrapea Top 50 Disney desde TMDb API
Guarda en: json/disney_top50.json
"""
...
GENEROS  = {28:"Acción",12:"Aventura",16:"Animación",35:"Comedia",80:"Crimen",18:"Drama",10751:"Familiar",14:"Fantasía",27:"Terror",878:"Ciencia Ficción"}
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key":API_KEY,"language":"es-ES","with_companies":"2|3","sort_by":"vote_average.desc","vote_count.gte":300,"page":page}
        try:
