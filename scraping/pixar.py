"""
StreamRank — scraper_pixar.py
Scrapea Top 50 Pixar desde TMDb API
Guarda en: json/pixar_top50.json
"""
...
# TMDb company ID para Pixar Animation Studios = 3
COMPANY_ID   = 3
COMPANY_NAME = "Pixar"
...
def fetch_peliculas():
    ...
    for page in range(1, 4):
        params = {"api_key":API_KEY,"language":"es-ES","with_companies":str(COMPANY_ID),"sort_by":"vote_average.desc","vote_count.gte":200,"page":page}
        try:
...
def main():
    ...
    for p in raw:
        ...
        limpias.append({
            ...
            "genero":        GENEROS.get(gids[0],"Animación") if gids else "Animación",
    ...
    resultado = {
        ...
        "plataforma":          "DISNEY+",
        "color":               "#0063e5",
        "descripcion":         "Lo mejor de Pixar Animation Studios",
